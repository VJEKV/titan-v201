...
import { BarChart, Bar, XAxis, YAxis, Tooltip, ResponsiveContainer, Legend, LabelList, LineChart, Line } from 'recharts';
...
export default function WorkTypes() {
  ...
  const donutData = types_data.map(d => ({ name: d.name, value: d.fact, count: d.count, pct: null }));
